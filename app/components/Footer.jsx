...
export default function Footer() {
  ...
  return (
    <footer className="bg-blue-100/30 text-white border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="pt-8 border-t border-slate-800">
          ...
          <div className="flex-shrink">
              <a href="/" className="flex items-center space-x-18">
                <div className="w-48 h-10  rounded-lg flex items-center justify-center">
